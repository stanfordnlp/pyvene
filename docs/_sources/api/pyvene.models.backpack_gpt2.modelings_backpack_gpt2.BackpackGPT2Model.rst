...
.. autoclass:: BackpackGPT2Model
   ...
   .. autosummary::
      ...
      ~BackpackGPT2Model.enable_peft_hotswap
      ...
      ~BackpackGPT2Model.get_correct_experts_implementation
      ~BackpackGPT2Model.get_decoder
      ~BackpackGPT2Model.get_encoder
      ~BackpackGPT2Model.get_expanded_tied_weights_keys
      ...
      ~BackpackGPT2Model.is_remote_code
      ~BackpackGPT2Model.kernelize
      ~BackpackGPT2Model.load_adapter
      ~BackpackGPT2Model.load_state_dict
      ~BackpackGPT2Model.mark_tied_weights_as_initialized
      ...
      ~BackpackGPT2Model.named_non_persistent_buffers
      ...
      ~BackpackGPT2Model.set_encoder
      ~BackpackGPT2Model.set_experts_implementation
      ...
      ~BackpackGPT2Model.set_use_kernels
   ...
   .. autosummary::
      ...
      ~BackpackGPT2Model.input_modalities
