...
.. autoclass:: GRULMHeadModel
   ...
   .. autosummary::
      ...
      ~GRULMHeadModel.enable_peft_hotswap
      ~GRULMHeadModel.eval
      ...
      ~GRULMHeadModel.get_correct_attn_implementation
      ~GRULMHeadModel.get_correct_experts_implementation
      ~GRULMHeadModel.get_decoder
      ~GRULMHeadModel.get_encoder
      ~GRULMHeadModel.get_expanded_tied_weights_keys
      ~GRULMHeadModel.get_extended_attention_mask
      ~GRULMHeadModel.get_extra_state
      ~GRULMHeadModel.get_init_context
      ...
      ~GRULMHeadModel.get_parameter_or_buffer
      ...
      ~GRULMHeadModel.initialize_weights
      ~GRULMHeadModel.invert_attention_mask
      ~GRULMHeadModel.ipu
      ~GRULMHeadModel.is_backend_compatible
      ~GRULMHeadModel.is_remote_code
      ~GRULMHeadModel.kernelize
      ~GRULMHeadModel.load_adapter
      ~GRULMHeadModel.load_state_dict
      ~GRULMHeadModel.mark_tied_weights_as_initialized
      ~GRULMHeadModel.modules
      ~GRULMHeadModel.mtia
      ~GRULMHeadModel.named_buffers
      ~GRULMHeadModel.named_children
      ~GRULMHeadModel.named_modules
      ~GRULMHeadModel.named_non_persistent_buffers
      ...
      ~GRULMHeadModel.set_attn_implementation
      ~GRULMHeadModel.set_decoder
      ~GRULMHeadModel.set_encoder
      ~GRULMHeadModel.set_experts_implementation
      ...
      ~GRULMHeadModel.set_use_kernels
   ...
   .. autosummary::
      ...
      ~GRULMHeadModel.can_record_outputs
      ...
      ~GRULMHeadModel.input_modalities
      ...
      ~GRULMHeadModel.pp_plan
      ~GRULMHeadModel.supports_gradient_checkpointing
      ~GRULMHeadModel.supports_pp_plan
      ~GRULMHeadModel.supports_tp_plan
      ~GRULMHeadModel.tp_plan
      ~GRULMHeadModel.tp_size
      ~GRULMHeadModel.use_kernels
