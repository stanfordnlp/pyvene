...
class PriceTaggingTask(TaskBase):
    ...
    def lower_bound_alignment_example_sampler(
        ...
        base_amount_sample = self.sample_with_region(
    ...
    def prepare_dataloader(self, tokenizer, **kwargs):
        ...
        if task_name == "price_tagging_lb":
            ...
            raw_data = self.bound_alignment_sampler(
                tokenizer,
                n_train+n_eval+1000,
                [self.lower_bound_alignment_example_sampler, self.upper_bound_alignment_example_sampler]
            )
        ...
        train_dataloader = DataLoader(
            train_dataset, batch_size=kwargs['train_batch_size'],
        )
        ...
        eval_dataloader = DataLoader(
            eval_dataset, batch_size=kwargs['eval_batch_size'],
        )
        ...
        test_dataloader = DataLoader(
            test_dataset, batch_size=kwargs['eval_batch_size'],
        )
    ...
    def lower_bound_alignment_example_sampler_with_triples(
        ...
        base_triples = self.sample_with_region_with_triples(base_region, triples)
        source_triples = self.sample_with_region_with_triples(source_region, triples)
