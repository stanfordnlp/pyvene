...
type_to_module_mapping = {
    ...
    hf_models.electra.modeling_electra.ElectraForPreTraining: electra_pretraining_type_to_module_mapping,
...
type_to_dimension_mapping = {
    ...
    hf_models.electra.modeling_electra.ElectraForPreTraining: electra_pretraining_type_to_dimension_mapping,
