...
blip_type_to_dimension_mapping = {
    'vis.block_input': ("hidden_size", ), 
    'vis.block_output': ("hidden_size", ), 
    'vis.mlp_activation': ("intermediate_size", ),
    'vis.mlp_output': ("hidden_size", ),
    'vis.mlp_input': ("hidden_size", ),
    'vis.attention_value_output': ("hidden_size/num_attention_heads", ),
    'vis.attention_output': ("hidden_size", ),
    'vis.attention_input': ("hidden_size", ),

    'lang.block_input': ("hidden_size", ),
    'lang.block_output': ("hidden_size", ),
    'lang.mlp_activation': ("intermediate_size", ),
    'lang.mlp_output': ("hidden_size", ),
    'lang.mlp_input': ("hidden_size", ),
    'lang.attention_value_output': ("hidden_size/num_attention_heads", ),
    'lang.attention_output': ("hidden_size", ),
    'lang.attention_input': ("hidden_size", ),

    'decoder.block_input': ("hidden_size", ),
    'decoder.block_output': ("hidden_size", ),
    'decoder.mlp_activation': ("intermediate_size", ),
    'decoder.mlp_output': ("hidden_size", ),
    'decoder.mlp_input': ("hidden_size", ),
    'decoder.self_attention_value_output': (),
    'decoder.self_attention_output': ("hidden_size", ),
    'decoder.self_attention_input': ("hidden_size", ),
    'decoder.cross_attention_value_output': ("hidden_size/num_attention_heads", ),
    'decoder.cross_attention_output': ("hidden_size", ),
    'decoder.cross_attention_input': ("hidden_size", ),
}
