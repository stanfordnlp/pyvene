    ...
    def forward(
        ...
        if position_bias is None:
            if not self.has_relative_attention_bias:
                ...
                position_bias = self.compute_bias(real_seq_length,
                                                  key_length,
                                                  device=scores.device)
...
class T5PreTrainedModel(PreTrainedModel):
    ...
    def _init_weights(self, module):
        ...
        if isinstance(module, T5LayerNorm):
            ...
            if hasattr(module,
                       "lm_head") and not self.config.tie_word_embeddings:
...
class AlignableT5Stack(T5PreTrainedModel):
    ...
    def parallelize(self, device_map=None):
        ...
        self.device_map = (get_device_map(len(self.block),
...
@add_start_docstrings("""T5 Model with a `language modeling` head on top.""",
                      T5_START_DOCSTRING)
class T5ForConditionalGeneration(T5PreTrainedModel, AlignableBase):
    _keys_to_ignore_on_load_missing = [
        r"encoder.embed_tokens.weight",
        r"decoder.embed_tokens.weight",
        r"lm_head.weight",
...
class T5Stack(T5PreTrainedModel):
    ...
    def forward(
        ...
        for i, (layer_module,
            ...
            # TODO: Here is where we check the alignment config and intervene (I think)
