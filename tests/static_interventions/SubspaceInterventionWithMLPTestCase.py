...
def suite():
    ...
    suite.addTest(SubspaceInterventionWithMLPTestCase('test_intervention_link_positive'))
    suite.addTest(SubspaceInterventionWithMLPTestCase('test_no_intervention_link_positive'))
    suite.addTest(SubspaceInterventionWithMLPTestCase('test_no_intervention_link_negative'))
    return suite
